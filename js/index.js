...
updateWeatherApp = (city) => {
  ...
  if (isDayTime(imageName)) {
    console.log("day");
    timeImage.setAttribute("src", "../img/body/day_image.svg");
    ...
    console.log("night");
    timeImage.setAttribute("src", "../img/body/night_image.svg");
...
//agregando un evento listener al form
